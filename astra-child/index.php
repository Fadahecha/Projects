...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo get_stylesheet_directory_uri() . '/media/img1.jpg' ?> " class="d-block w-100"
                alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?php echo get_stylesheet_directory_uri() . '/media/img2.jpg' ?>" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="<?php echo get_stylesheet_directory_uri() . '/media/img3.jpg' ?>" class="d-block w-100" alt="...">
        </div>
    </div>
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                                    src="<?php echo get_stylesheet_directory_uri() . '/media/google-play-badge.svg' ?>"
                                    alt="..." /></a>
                            <a href="#!"><img class="app-badge"
                                    src="<?php echo get_stylesheet_directory_uri() . '/media/app-store-badge.svg' ?>"
                                    alt="..." /></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%">
                                        <source
                                            src="<?php echo get_stylesheet_directory_uri() . '/media/demo-screen.mp4' ?>"
                                            type="video/mp4" />
                                    </video>
                                </div>
                            </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri() . '/media/tnw-logo.svg' ?>" alt="..."
                        style="height: 3rem" />
                </div>
            </div>
        </div>
                    ...
                    <div class="container-fluid px-5">
                        <div class="row gx-5">
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="text-center">
                                    <i class="fa fa-mobile icon-feature text-gradient d-block mb-3"></i>
                            ...
                            <div class="col-md-6 mb-5">
                                <!-- Feature item-->
                                <div class="text-center">
                                    <i class="fa fa-camera icon-feature text-gradient d-block mb-3"></i>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-5 mb-md-0">
                                <!-- Feature item-->
                                <div class="text-center">
                                    <i class="fa fa-gift icon-feature text-gradient d-block mb-3"></i>
                            ...
                            <div class="col-md-6">
                                <!-- Feature item-->
                                <div class="text-center">
                                    <i class="fa fa-globe icon-feature text-gradient d-block mb-3"></i>
